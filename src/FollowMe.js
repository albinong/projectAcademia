...
function Exames() {
  // Definição de estados utilizando o Hook useState para controlar os campos do formulário
  ...
  const handleSubmit = (event) => {
    ...
    setMensagem('');
    // Exibir um alerta
    window.alert(`Ola 😊😊!${nome}, a sua mensagem de Recurso foi recebida com sucesso.`);
  ...
  return (
    <div className="headerfoto">
      ...
      <header>Exames de Concurso</header> {/* Título do componente */}
...
export default Exames; // Exporta o componente Exames para uso em outras partes da aplicação